...
export const graphqlCodexLayerChildren = ({
  bothGroupRef,
...
export const graphqlShortsCodexLayerChildren = ({
  bothGroupRef,
  onlyFragmentGroupRef,
  computedTokens,
  position,
  ...
  return [
    <Group x={0} y={0}>
      <Rect
        ...
        fill="#1F2937"
      />
      <Image image={circleGroup} x={100} y={600} />
      <Image image={graphqlLogo} x={30} y={SHORTS_CONFIG.height - 55} />
    </Group>,
    <Group x={0} y={0} opacity={0} ref={bothGroupRef}>
      <Rect
        x={13}
