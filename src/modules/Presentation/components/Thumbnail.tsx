...
const Thumbnail = ({
  ...
  const {
    ...
    ownerDesignation,
    ownerOrganization,
  } = useRecoilValue(presentationStore)
  ...
  useEffect(() => {
    ...
    setThumbnailInfo({
      ...
      userName: introBlockViewProps?.name || ownerName || '',
      designation: introBlockViewProps?.designation || ownerDesignation || '',
      organization:
        introBlockViewProps?.organization || ownerOrganization || '',
    })
    setIntroConfig(
      getIntroConfig({
        theme,
