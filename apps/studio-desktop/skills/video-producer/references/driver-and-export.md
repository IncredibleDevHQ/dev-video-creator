...
> Reference for the `video-producer` skill. Source: *The Motion Decision Core*, sections §4. Read only when the routing table triggers it.

The driver contract publish relies on: init, state fold, determinism and frame exactness.
