...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* The three image layouts must stay distinct even when a presenter
       layout fixes the content geometry inline: identity lives on the
       figure. Gallery = full-width editorial frame; Hero = chromeless
